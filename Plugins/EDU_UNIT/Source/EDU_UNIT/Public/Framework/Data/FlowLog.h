...
DECLARE_LOG_CATEGORY_EXTERN(FlowLog_UNIT, Display, All);
DECLARE_LOG_CATEGORY_EXTERN(FlowLog_UNIT_TICK, Display, All);

//Define External Log Category
inline DEFINE_LOG_CATEGORY(FlowLog_UNIT);
inline DEFINE_LOG_CATEGORY(FlowLog_UNIT_TICK);

// Define Internal Macro for this .h file
#define FLOWLOG_CATEGORY FlowLog_UNIT
#define FLOWLOG_TICK_CATEGORY FlowLog_UNIT_TICK
