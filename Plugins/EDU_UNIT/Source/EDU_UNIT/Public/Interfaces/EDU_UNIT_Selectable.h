...
#include "EDU_UNIT_Selectable.generated.h"
...
------------------------------------------------------------------------------*/
UINTERFACE()
class EDU_UNIT_API UEDU_UNIT_Selectable : public UInterface // Unreal’s reflection system
{
	GENERATED_BODY()
};
...
------------------------------------------------------------------------------*/
class EDU_UNIT_API IEDU_UNIT_Selectable // Actual interface functionality
{
	GENERATED_BODY()
//------------------------------------------------------------------------------
// Functionality
