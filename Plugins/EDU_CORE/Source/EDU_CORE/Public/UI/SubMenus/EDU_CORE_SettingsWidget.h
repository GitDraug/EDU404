...
#include "EDU_CORE_SettingsWidget.generated.h"

class UCommonTextBlock;
class UEDU_CORE_SelectionWidget;
class UWidget;
...
//------------------------------------------------------------------------------	
UENUM(BlueprintType)
enum class EDU_CORE_EFramerate: uint8
{
...
//------------------------------------------------------------------------------	
UENUM(BlueprintType)
enum class EDU_CORE_EQuality: uint8
{
...
public:
	...
	// -------------------------------------------------------------------
	static int EFramerateToValue(const EDU_CORE_EFramerate& Framerate)
	{
		switch (Framerate)
		{
			case EDU_CORE_EFramerate::FPS_30: return 30;
			case EDU_CORE_EFramerate::FPS_45: return 45;
			case EDU_CORE_EFramerate::FPS_60: return 60;
			case EDU_CORE_EFramerate::FPS_75: return 75;
			case EDU_CORE_EFramerate::FPS_120: return 120;
			case EDU_CORE_EFramerate::FPS_240: return 240;
			case EDU_CORE_EFramerate::FPS_Uncapped: return 0;
			default: return 60;
		}
	}
	// -------------------------------------------------------------------
	...
	// -------------------------------------------------------------------
	static FString FramerateToString(const EDU_CORE_EFramerate& Framerate)
	{
	...
	// -------------------------------------------------------------------
	static FText EQualityToString(const EDU_CORE_EQuality& Quality)
	{
		switch (Quality)
		{
			case EDU_CORE_EQuality::Lowest:	return FText::FromString(TEXT("Lowest"));
			case EDU_CORE_EQuality::Low:		return FText::FromString(TEXT("Low"));
			case EDU_CORE_EQuality::Medium:	return FText::FromString(TEXT("Medium"));
			case EDU_CORE_EQuality::High:	return FText::FromString(TEXT("High"));
			case EDU_CORE_EQuality::Highest:	return FText::FromString(TEXT("Highest"));
		}
...
UCLASS()
class EDU_CORE_API UEDU_CORE_SettingsWidget : public UCommonActivatableWidget
{
	GENERATED_BODY()
...
protected:
	...
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> FramerateSelectionWidget;
	...
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> AntiAliasingQualitySelectionWidget;
	
	//-------------------------------------------------------------
	// Foliage Quality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> FoliageQualitySelectionWidget;

	//-------------------------------------------------------------
	// Global Illumination Quality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> GlobalIlluminationQualitySelectionWidget;

	//-------------------------------------------------------------
	// PostProcessing Quality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> PostProcessingQualitySelectionWidget;
	
	//-------------------------------------------------------------
	// Reflection Quality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> ReflectionQualitySelectionWidget;

	//-------------------------------------------------------------
	// ShadingQuality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> ShadingQualitySelectionWidget;

	//-------------------------------------------------------------
	// Shadow Quality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> ShadowQualitySelectionWidget;
	
	//-------------------------------------------------------------
	// Texture Quality
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> TextureQualitySelectionWidget;
	...
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> VFXQualitySelectionWidget;

	//-------------------------------------------------------------
	// View Distance
	//-------------------------------------------------------------
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UEDU_CORE_SelectionWidget> ViewDistanceQualitySelectionWidget;
	//------------------------------------------------------------------------------
// Functionality
//------------------------------------------------------------------------------
private:
