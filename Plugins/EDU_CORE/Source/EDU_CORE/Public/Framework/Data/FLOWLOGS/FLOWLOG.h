...
//-------------------------------------------------------
  #define FLOW_LOG_ONSCREEN_MESSAGE(Message) if(GEngine) \
    { GEngine->AddOnScreenDebugMessage(-1, 20.f, FColor::Green, FString::Printf(TEXT("%s::%hs - %s"), *GetName(), __FUNCTION__, TEXT(Message))); };

  #define FLOW_LOG_ONSCREEN_WARNING(Message) if(GEngine) \
    { GEngine->AddOnScreenDebugMessage(-1, 20.f, FColor::Yellow, FString::Printf(TEXT("%s::%hs - %s"), *GetName(), __FUNCTION__, TEXT(Message))); };

  #define FLOW_LOG_ONSCREEN_ERROR(Message) if(GEngine) \
    { GEngine->AddOnScreenDebugMessage(-1, 20.f, FColor::Red, FString::Printf(TEXT("%s::%hs - %s"), *GetName(), __FUNCTION__, TEXT(Message))); };

  #define FLOW_ONSCREEN_TOSTRING(Key, Color, Message) if(GEngine) \
    { GEngine->AddOnScreenDebugMessage(Key, 60.f, FColor::Color, FString::Printf(TEXT("%s::%hs - %s"), *GetName(), __FUNCTION__, *Message.ToString() )); };
