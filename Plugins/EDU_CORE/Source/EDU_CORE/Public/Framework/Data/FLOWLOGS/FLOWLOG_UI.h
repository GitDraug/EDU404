...
DECLARE_LOG_CATEGORY_EXTERN(FlowLog_UI, Display, All);
DECLARE_LOG_CATEGORY_EXTERN(FlowLog_UI_TICK, Display, All);

//Define External Log Category
inline DEFINE_LOG_CATEGORY(FlowLog_UI);
inline DEFINE_LOG_CATEGORY(FlowLog_UI_TICK);

// Define Internal Macro for this .h file
#define FLOWLOG_CATEGORY FlowLog_UI
#define FLOWLOG_TICK_CATEGORY FlowLog_UI_TICK
