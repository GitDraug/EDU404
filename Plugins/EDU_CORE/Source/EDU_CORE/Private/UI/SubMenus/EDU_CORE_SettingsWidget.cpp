...
#include "UI/SubMenus/EDU_CORE_SettingsWidget.h"
...
{ 
	...
	//------------------------------------------------------------------------------
	constexpr EDU_CORE_EFramerate FramerateOptionsArray[] = {
		EDU_CORE_EFramerate::FPS_30,
		EDU_CORE_EFramerate::FPS_45,
		EDU_CORE_EFramerate::FPS_60,
		EDU_CORE_EFramerate::FPS_75,
		EDU_CORE_EFramerate::FPS_120,
		EDU_CORE_EFramerate::FPS_240,
		EDU_CORE_EFramerate::FPS_Uncapped,
	};

	//------------------------------------------------------------------------------
	// Used by InitializeQualitySettings()
	//------------------------------------------------------------------------------
	constexpr EDU_CORE_EQuality QualityOptionsArray[] = {
		EDU_CORE_EQuality::Lowest,
		EDU_CORE_EQuality::Low,
		EDU_CORE_EQuality::Medium,
		EDU_CORE_EQuality::High,
		EDU_CORE_EQuality::Highest,
	};
	...
	{
		UEDU_CORE_SelectionWidget* SelectionWidget;
